...
public class QuanLyNguyenLieuDAO implements INguyenLieu {
	...
	public List<NguyenLieu> getList() throws ClassNotFoundException, SQLException {
		...
		while (rs.next()) {
			...
			String ma_lnl = rs.getString("MA_LNL");
			String ma_ncc = rs.getString("MA_NCC");
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		QuanLyNguyenLieuDAO ql = new QuanLyNguyenLieuDAO();
