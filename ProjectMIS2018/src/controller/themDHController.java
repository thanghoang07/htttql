...
/**
 * Servlet implementation class themDHController
 */
@WebServlet("/themDHController")
public class themDHController extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public themDHController() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			//
			String maDonHang = autoID.autoMaDonHang();
			//
